...
document.addEventListener('alpine:init', () => {
    Alpine.store('page', {
        websites: {
            images: [
                {href: 'https://ami-hp.github.io/mikhak/',                github:'https://github.com/ami-hp/mikhak/',                title: 'Mikhak',                     class: 'mikhak',         year: '2025', contribute: false , skills: {webpack: false, javascript: true, jquery: false, alpine: false,bootstrap: false, laravel: false,  php:false, sass:false, tailwind: true , rest: false, angular: true}},
